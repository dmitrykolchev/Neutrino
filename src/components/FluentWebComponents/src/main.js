import { setTheme, accordionDefinition, accordionItemDefinition, ButtonDefinition, FluentDesignSystem, SpinnerDefinition, SliderDefinition, MenuDefinition, MenuListDefinition, MenuButtonDefinition, MenuItemDefinition, TextInputDefinition, TextAreaDefinition, LabelDefinition, FieldDefinition, RadioGroupDefinition, RadioDefinition, CheckboxDefinition, } from '@fluentui/web-components';
import { webDarkTheme, webLightTheme } from '@fluentui/tokens';
const themes = {
    "dark": webDarkTheme,
    "light": webLightTheme
};
export function setFluentTheme(theme) {
