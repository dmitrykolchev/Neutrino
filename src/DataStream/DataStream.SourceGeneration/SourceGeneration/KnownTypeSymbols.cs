// <copyright file="KnownTypeSymbols.cs" company="Division By Zero">
...
internal sealed class KnownTypeSymbols
{
    ...
    public INamedTypeSymbol? DataStreamSerializableAttributeType => GetOrResolveType("DataStream.DataStreamSerializableAttribute", ref _DataStreamSerializableAttributeType);
    private Option<INamedTypeSymbol?> _DataStreamSerializableAttributeType;
    ...
    public INamedTypeSymbol? SerializationInfoType => GetOrResolveType(typeof(System.Runtime.Serialization.SerializationInfo), ref _SerializationInfoType);
